...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["marinersaldeburgh.com"]
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="MarinerBookings <noreply@marinersaldeburgh.com>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[MarinerBookings]"
)
